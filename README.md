...
Doing TNA properly requires many types of data: goal alignment records, operational data, staff interviews, SME interviews, learner profiles...   
The traditional way is dozens of scattered files filled in by hand, retyped, consolidated manually.   
...
Report bugs or request features: [open an Issue](../../issues) or fill in the [feedback form](https://forms.gle/hHo6virmGAQAnaccA).  
When reporting a bug, please include: browser + device + app version (see the app footer).
